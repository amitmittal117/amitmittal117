...
<p align="center">
  <b>AI-Focused Full-Stack Software Engineer</b>  
  <br/>
  Building intelligent systems that learn, adapt, and automate.  
  <br/>
  <img src="/India-square-flag.png" width="14"/> India → <img src="/united-states.png" width="14"/> San Jose, USA
</p>
...
- ⚙️ Deploy & scale production workloads on **Kubernetes, Jenkins, Helm, and Docker**  
...
### 🔭 Currently Building
🧩 **Multi-Agent Orchestration System** – integrating OpenHands, Llama 3.2 (Ollama), and LangChain with FastMCP.  
🛰️ **ArcGIS Enterprise Issue Tracker** – React + Redux + Flask backend with pipeline automation.  
🧠 **Kubernetes AI-Ops Tool** – health-check & auto-remediation microservice for local clusters.
...
## 📈 Activity Overview
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=amitmittal117&theme=tokyo-night&hide_border=true&area=true&area_color=5F9EA0&line=70a5fd" width="95%" alt="Contribution Graph"/>
</p>
